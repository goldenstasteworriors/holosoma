"""SONIC tracking randomization presets for the G1 robot."""
...
g1_29dof_sonic_randomization = RandomizationManagerCfg(
    setup_terms={**base_setup_terms},
    reset_terms={**base_reset_terms},
    step_terms={**base_step_terms},
)

g1_29dof_sonic_randomization_w_object = RandomizationManagerCfg(
    setup_terms={
        **base_setup_terms,
        **object_state_dr_at_setup,
    },
...
__all__ = ["g1_29dof_sonic_randomization", "g1_29dof_sonic_randomization_w_object"]
